...
namespace Rigel.EGUI
{
    public class GUICtx
    {
        ...
        {
            System.Diagnostics.Debug.Assert(groupStack.Count == 0);
            System.Diagnostics.Debug.Assert(areaStack.Count == 0);

            System.Diagnostics.Debug.Assert(layoutStack.Count == 0);
            System.Diagnostics.Debug.Assert(depthLayer.Count == 0);
